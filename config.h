...
static const char col_cyan[]        = "#aa2200";
...
static Key keys[] = {
       ...
       { MODKEY|ShiftMask,     33,    spawn,          {.v = dmenucmd } }, // p
       ...
       { MODKEY,               59,    focusmon,       {.i = -1 } },      // semicolon
       { MODKEY,               60,    focusmon,       {.i = +1 } },      // colon
       { MODKEY|ShiftMask,     59,    tagmon,         {.i = -1 } },      // semicolon
       { MODKEY|ShiftMask,     60,    tagmon,         {.i = +1 } },      // colon
       TAGKEYS(                10,                    0)                 // 1
       TAGKEYS(                11,                    1)                 // 2
       TAGKEYS(                12,                    2)                 // 3
       TAGKEYS(                13,                    3)                 // 4
